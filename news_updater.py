...
QUERIES = {
    ...
    'thub':  '"Indian startup" OR "India startup" OR "India tech" OR "India unicorn" OR "India innovation"',
}
...
FILTERS = {
    ...
    'thub':  ['india', 'indian', 'startup', 'tech', 'innovation', 'hyderabad', 'bengaluru', 'bangalore'],
}
